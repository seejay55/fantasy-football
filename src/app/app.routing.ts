...
const routes: Routes = [
  ...
  { path: 'league/:_id/team/:teamName',                 component: TeamInformationPageComponent,     data: { breadcrumb: 'Team Info'}},
  // Riley
  ...
  { path: 'league/:leagueId/settings',        component: LeagueOptionsPageComponent,          data: { breadcrumb: 'League Options'}},
  // Preston
